...
public class BuchLeihenColumnsMitID {
    ...
    public BuchLeihenColumnsMitID(int buchID, String buchname, String author, String auflagesdatum, String thema, String verlag, String studentnummer, String datum) {
        this.buchID = buchID;
